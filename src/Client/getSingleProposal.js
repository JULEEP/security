        ...
        <div className="flex justify-between items-start p-10">
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-800">
              Client: {proposal.client?.company}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between px-10">
          ...
          <div className="space-y-6 border-r border-gray-200 pr-8 w-[50%] pt-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">{proposal.overview}</p>
            </div>
          ...
          <div className="space-y-4 pl-10 w-[50%] pt-6">
            ...
            <div>
              ...
              <div className="flex justify-between">
                ...
                <p className="text-sm">{proposal.timeline?.start?.slice(0, 10)}</p>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-700">End Date:</span>
                <p className="text-sm">{proposal.timeline?.end?.slice(0, 10)}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">${proposal.total}</p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc text-sm text-gray-700 space-y-1 ml-4">
                {proposal.termsAndConditions?.map((term, index) => (
