...
function Profile1() {
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      <img
        src="https://source.unsplash.com/random/1572x795"
        alt="Hero"
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            Hello, <br />
            This is{" "}
            <span className=" text-pink-500">Shraddha</span>
            {`, I'm a Professional `}
            <span className=" text-[#16f2b3]">Website Developer</span>.
          </h1>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">'</span>
                <span className="text-amber-300">Shraddha Salvi</span>
                <span className="text-gray-400">',</span>
              </div>
              ...
              <div className="ml-8 lg:ml-16">);</div>
              <div className="ml-4 lg:ml-8">{'}'}</div>
              <div>{'}'}</div>
            </code>
          </div>
        </div>
