...
import FreelancerLogin from "./Pages/freelancer/auth/Login";
import FreelancerRegister from "./Pages/freelancer/auth/Register";
import ClientRegister from "./Pages/client/auth/Register";
import ClientLogin from "./Pages/client/auth/Login";

import AdminRoutes from "./Routes/FreelancerRoutes";
...
function App() {
  return (
    <Routes>
      {/* Public Routes */}
      <Route path="/" element={<FreelancerLogin/>} />
